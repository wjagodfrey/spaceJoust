...
(function() {
  var HUD, Item, Item_Spawner, Player, addPlayerVelocity, applyPhysics, bombId, entity, events, fireEvent, frame, gameCanvas, gameCq, gravity, hasBoxHit, hasMouseHit, item, level, levels, loadLevel, loaded, mouse, mouseDownHandler, mouseMoveHandler, mouseUpHandler, onEvent, players, removePlayerVelocity, resizeFactor, root, touchDown, touchMove, touchTimeout,
    __slice = [].slice,
  ...
  entity.SuddenDeath = (function() {
    ...
    SuddenDeath.prototype.draw = function(ctx) {
      return ctx.save().fillStyle('orange').fillRect(Math.round(this.x), Math.round(this.y), this.width, this.height).restore();
    };
  ...
  levels.level_middle = {
    ...
    onBuild: function() {
      ...
      this.midground = {
        ...
        suddenDeath: new entity.SuddenDeath(this, 10)
      };
