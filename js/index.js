...
(function() {
  var HUD, Item, Item_Spawner, Player, addPlayerVelocity, applyPhysics, bombId, entity, events, fireEvent, frameTimeouts, gameCanvas, gameCq, gravity, hasBoxHit, hasMouseHit, item, level, levels, loadLevel, loaded, mouse, mouseDownHandler, mouseMoveHandler, mouseUpHandler, onEvent, players, removePlayerVelocity, resizeFactor, root, setFrameTimeout, touchDown, touchMove, touchTimeout, updateFrameTimeouts,
    __slice = [].slice,
